...
class Ui_window(object):
    ...
    def retranslateUi(self, window):
        ...
        self.bSelectMedia.setText(_translate("window", "选择文件"))
        self.bConvert.setText(_translate("window", "听识字幕"))
        self.bOpenOutputFolder.setText(_translate("window", "打开字幕输出目录"))
        self.bSelectOutputFolder.setText(_translate("window", "输出目录"))
        self.groupBox.setTitle(_translate("window", "&要听识字幕的文件"))
        self.bRemoveFile.setText(_translate("window", "移除文件出听识名单"))
        self.bCancel.setText(_translate("window", "取消"))
        self.chbxOpenOutputFilesAuto.setText(_translate("window", "完成后自动打开字幕"))
        self.labelSelectLang.setText(_translate("window", "音频语言:"))
        self.menuAbout.setTitle(_translate("window", "关于"))
        self.actionLicense.setText(_translate("window", "&License"))
        self.actionDonation.setText(_translate("window", "&捐款"))
        self.actionAbout_pyTranscriber.setText(_translate("window", "&关于 pyTranscriber"))
